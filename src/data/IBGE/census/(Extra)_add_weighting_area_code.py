...
def structure_data(input_filepath,
                   reference_filepath,
...
if __name__ == '__main__':
    ...
    state = 'RS'
    # Set paths
    input_filepath = project_dir + '/data/raw/{}/IBGE/census_data/{}/census_tract/universal_results/{}/'.format(country, census_year, state)
    reference_filepath = project_dir + '/data/raw/{}/IBGE/census_data/{}/weightening_area/weightening_area_by_census_tract.csv'.format(country, census_year, state)
    digital_mesh_filepath = project_dir + '/data/raw/{}/IBGE/digital_mesh/census_tract/{}/43SEE250GC_SIR.shp'.format(country, census_year, state)

    output_filepath = project_dir + '/data/interim/{}/IBGE/census_data/{}/census_tract/universal_results/states/{}/'.format(country, census_year,state)
    output_digital_mesh = project_dir + '/data/interim/{}/IBGE/census_data/{}/census_tract/digital_mesh/{}.geojson'.format(country, census_year, state)
