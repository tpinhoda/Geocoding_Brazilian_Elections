...
if __name__ == '__main__':
    ...
    # Set paths
    input_filepath = project_dir + '/data/interim/{}/IBGE/census_data/{}/census_tract/universal_results/states/{}/'.format(country, census_year,state)
    output_filepath = project_dir + '/data/interim/{}/IBGE/census_data/{}/weightening_area/universal_results/states/{}/'.format(country, census_year, state)

    digital_mesh_filepath = project_dir + '/data/interim/{}/IBGE/digital_mesh/census_tract/{}.geojson'.format(country, census_year, state)
    output_digital_mesh = project_dir + '/data/interim/{}/IBGE/digital_mesh/weighting_area/{}.geojson'.format(country, census_year, state)
