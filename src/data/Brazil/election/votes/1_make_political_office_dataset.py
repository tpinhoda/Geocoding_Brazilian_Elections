...
if __name__ == '__main__':
    ...
    turn = '2'
    # Set paths
    input_filepath = project_dir + '/data/raw/{}/TSE/election_data/{}/turn_{}/'.format(country, election_year, turn)
    output_filepath = project_dir + '/data/interim/{}/TSE/election_data/{}/{}/turn_{}/states/'.format(country, election_year, office_folder,turn)
