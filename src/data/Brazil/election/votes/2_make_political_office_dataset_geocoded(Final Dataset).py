...
if __name__ == '__main__':
	...
	#Set paths
	tse_input_filepath = project_dir + '/data/interim/{}/election_data/{}/{}/turn_{}/states/'.format(country,election_year,office_folder,turn)
	geo_input_filepath = project_dir + '/data/processed/{}/election_data/{}/polling_places/polling_places.csv'.format(country,election_year)
	states_output_filepath = project_dir + '/data/processed/{}/election_data/{}/{}/turn_{}/states/'.format(country,election_year,office_folder,turn)
	final_dataset_output_filepath = project_dir + '/data/processed/{}/election_data/{}/{}/turn_{}/data.csv'.format(country,election_year,office_folder,turn)
