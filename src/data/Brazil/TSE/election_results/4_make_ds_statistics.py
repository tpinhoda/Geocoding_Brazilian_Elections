...
def n_cities(original, cleaned):
    ...
    left_cities = len(original.groupby('CD_MUNICIPIO')) - len(cleaned.groupby('CD_MUNICIPIO'))
...
def generate_summary_report(original_data,
                            cleaned_data,
                            aggregate_level):
    ...
    summary_report = {'Cities': cities['represented'],
...
if __name__ == '__main__':
    ...
    parameters_report = generate_parameters_report(aggregate_level, city_limits, precision_categories,
