...
def run(region, year, office_folder, turn):
    ...
    election_results_interim_path = election_results_path.format(region, year, 'interim')
    polling_places_processed_path = polling_places_path.format(region, year, 'processed')
    # Set paths
