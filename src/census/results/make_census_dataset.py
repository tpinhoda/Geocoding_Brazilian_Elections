...
def make_interim_data(region, year, aggr):
    add_codes_to_datasets.run(region=region, year=year, aggr=aggr)
...
def make_processed_data(region, year, aggr):
    with mlflow.start_run():
        ...
        concat_datasets.run(region=region, year=year, aggr=aggr)
        make_joined_datasets.run(region=region, year=year, aggr=aggr)
