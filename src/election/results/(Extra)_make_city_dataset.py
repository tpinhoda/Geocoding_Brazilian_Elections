...
if __name__ == "__main__":
    ...
    input_filepath = (
        project_dir
        + "/data/interim/Brazil/election_data/{}/{}/turn_{}/states/".format(
            election_year, political_office, turn
        )
    )
    output_filepath = (
        project_dir
        + "/data/interim/Brazil/election_data/{}/{}/turn_{}/cities/non_capitals/".format(
            election_year, political_office, turn
        )
    )
